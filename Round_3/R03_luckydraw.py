...
# Random number request Tx: https://rinkeby.etherscan.io/tx/0x0f700c9b56146f64c8742d868ed92426c825299a3f9f9179594e17b047bab4ca#statechange
# The last random number is: 0x5a8b72202bb5706386ef8789a2e3a5152ca960cff30a8676d48cbb5df48ae162
# We use this as seed

# Random seed is obtained from VRF (see process above)
random.seed(0x5a8b72202bb5706386ef8789a2e3a5152ca960cff30a8676d48cbb5df48ae162)

# Read staking snapshot
signup_df_reduce = pd.read_csv('R03_signup_table_reduced.csv')
